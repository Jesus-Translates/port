...
The Oeste is the Atlantic strip north-west of Lisbon: surf coast on one side, market towns
and intensive farming on the other, with almost nothing in between. It is not a resort
region and not a suburb — it is working country that happens to have world-class waves
at the end of every side road.

Administratively, "Oeste" is a real unit, not a marketing label. The **Comunidade
Intermunicipal do Oeste (OesteCIM)** and the NUTS III *Oeste* cover twelve municipalities:
Alcobaça, Alenquer, Arruda dos Vinhos, Bombarral, Cadaval, Caldas da Rainha, Lourinhã,
Nazaré, Óbidos, Peniche, Sobral de Monte Agraço and Torres Vedras. Note for accuracy:
**Mafra and Ericeira are *not* in OesteCIM** — the concelho de Mafra belongs to the Área
Metropolitana de Lisboa — but residents there live the same coastal-and-farming life and
are usually spoken of as part of the same coast.

The zone straddles two districts, which matters for paperwork: **distrito de Lisboa**
covers Torres Vedras, Lourinhã and Mafra; **distrito de Leiria** covers Peniche, Óbidos,
...
A low, rolling coastal platform cut by short rivers, ending in **arribas** (sea cliffs)
...
- **Lagoa de Óbidos** — roughly 17 km², the most extensive coastal lagoon on the Portuguese
  ...
  alongside sailing, windsurf, canoeing and paddle.
- **Peniche** sits on what was an island, joined to the mainland by a **tómbolo** that only
  became permanent land in the 18th century. **Baleal** north of it is the same story in
  miniature — an ex-island joined by a sand isthmus.

**Climate.** Mild, damp, and above all windy. The defining feature is the **nortada**: the
north / north-westerly that gets up in the afternoon, strongest between May and September.
It knocks several degrees off a hot day, throws sand across the beach towels, and — via
upwelling — keeps the sea genuinely cold all summer. Residents dress for it: a fleece for
the evening in August is normal, and "está muita nortada" is an ordinary afternoon remark.
Winters are wet and grey rather than cold; sea fog (nevoeiro) rolls in off the Atlantic.
The water is cold enough that wetsuits are worn year-round.
...
- **Fortaleza de Peniche** — a political prison of the Estado Novo from the 1930s until
  1974, and the site of Álvaro Cunhal's celebrated 1960 escape. Since **27 April 2024** it
  houses the **Museu Nacional Resistência e Liberdade**, opened fifty years to the day
...
- **Muralhas de Óbidos**, the **Porta da Vila** (a double dog-leg gateway, with the Capela
  ...
  ordered by D. Catarina to feed the Fonte da Vila.
- **Hospital Termal Rainha D. Leonor**, Caldas da Rainha — founded 1485 by Queen D. Leonor
...
- **Museu da Lourinhã** — the largest Iberian collection of Upper Jurassic dinosaur fossils;
  ...
  **Lourinhanosaurus antunesi** and the **ninho de Paimogo** (a nest with egg-embryo
  remains, globally rare) are the icons. **Dino Parque Lourinhã** is the open-air companion.
  **Forte de Paimogo** dates from 1674.
- **Bacalhôa Buddha Eden**, about 4 km outside Bombarral — a large sculpture garden laid
  out among the vines.
- **Aldeia Típica José Franco** at Sobreiro, Mafra — a hand-built miniature village with
  pottery and a bakery *(unverified in this research pass)*.
...
- **Santuário de Nossa Senhora da Nazaré**, at the Sítio. The legend has **D. Fuas Roupinho**
  ...
  church. The venerated image is a **Virgem Negra** carved in wood, said to have been
  brought from Mérida in 711 by Frei Romano.
- **Mosteiro de Alcobaça** — still the parish focus of the town as well as a monument.
- **Igreja de Santa Maria**, Óbidos — the town's main church, on the central square, walls
  lined with 17th-century azulejos and paintings by **Josefa de Óbidos**.
- **Igreja de Nossa Senhora do Pópulo**, Caldas da Rainha — late-Gothic, built with the
  thermal hospital.
- **Torres Vedras**: **Igreja de São Pedro**, **Igreja de Santa Maria do Castelo**, and the
  **Igreja e Convento da Graça**.
- **Ericeira**: **Igreja Paroquial de São Pedro da Ericeira**, the **Capela de São Sebastião**,
  and the **Capela de Nossa Senhora da Boa Viagem e Santo António** — the dedication to
  *Boa Viagem* tells you what the town prayed about.
- **Peniche**: the patronal feast is **Nossa Senhora da Boa Viagem**, kept on the Monday
  after the first Sunday in August, with a procession that goes out onto the water.

Every freguesia has its **igreja matriz** and its own **festa** with a procession; wayside
chapels (**ermidas**, **capelinhas**) at crossroads are ordinary features of the landscape.
...
- `Ginjinha de Óbidos` — the liqueur made by macerating the ginja for at least a year. Order
...
- **Wine.** The regional appellation is **Vinho Regional Lisboa** (until recently called
  *Estremadura*), and its wine commission sits in **Torres Vedras**. Within it the Oeste
  ...
  aguardente designations.)*
- **Coffee, said the local way.** `uma bica` is the espresso — a Lisbon-and-southward term,
  so it is correct here. Do **not** use `um cimbalino` or `um pingo`; those are Porto and
  northern. Also: `um garoto` (small white coffee), `uma meia de leite` (large cup),
  `um galão` (tall glass, milky), `um abatanado` (longer, weaker), `um café pingado`.
  `Um fino` or `uma imperial` for a small draught beer.
...
- `Támares` (Nazaré) — small boat-shaped cakes filled with egg sweet. Also named locally:
  *sardinha doce*, *nazarenos*.
- `Pão de Mafra` — a **pão de mistura** of wheat and rye, no additives, soft crust *and*
  crumb, sold *redondo*, *comprido* or *em bolinhas*. Originally the *pão saloio*. There is
  a **Festival do Pão de Mafra** in July. Mafra also does `queijo fresco`, `carracenas` and
  `trouxas da Malveira`.
- `Doçaria conventual` is the regional sweet tradition, tied to the Mosteiro de Alcobaça,
  which hosts an annual **Mostra de Doces Conventuais** in **November**.

**Savoury**

- `Caldeirada de Peniche` (fuller: *caldeirada de Peniche à pescador*) — the layered fish
...
- `Caneja d'infundice` (Ericeira) — the most distinctive dish on this coast. A small shark
  ...
  wine. A winter fishermen's dish with its own **Confraria**. *(For speech, the attested
  alternate spelling `caneja de infundice` is easier.)*
- `Caldeirada à moda da Nazaré` — descended from the **quinhão**, the crew's share of small
  or damaged fish taken home and boiled. Needs at least three fish plus lulas and amêijoas.
- `Carapau seco` (Nazaré) — the sun-drying on the sand is a genuine living practice: fish
  gutted, salted, **escalado** (split open) and laid out on **paneiros** for two or three
  days. Half-dried fish is **enjoado**. The idiom **"seco que nem um carapau da Nazaré"** is
...
**Everyday eating.** Coffee and a pastry standing at the balcão in the morning; the
`prato do dia` at a tasca at lunch — bread, olives, soup, main, drink, dessert and coffee
for around €10; grilled fish on the coast in summer; the long Sunday lunch with family.
Note two traps: a local custard tart is a **`pastel de nata`**, never a "pastel de Belém"
(that name belongs only to the Lisbon original); and **francesinha is Porto's**, not this
region's, however common it is on menus.

**An honest gap.** Torres Vedras, Santa Cruz, Silveira, Bombarral and Lourinhã have **no
verifiable savoury dish of their own**. For a family on that stretch of coast the truthful
local food is the *pastel de feijão*, the Lagoa de Óbidos shellfish, the Lourinhã brandy,
the pêra rocha off the surrounding land, and the Peniche or Ericeira dishes a short drive
in either direction. Do not invent a "prato de Santa Cruz".
...
Ericeira, Baleal and Nazaré becomes impossible, restaurants queue, and the population of
some places multiplies. From November to March the same streets are half-shuttered, the
surf schools run on a skeleton, and the wind and rain come in off the Atlantic. Residents
talk about `a época` (the season) and `fora de época` constantly.

## Festivals & calendar

**Carnaval de Torres Vedras** — the big one, and nationally significant. Organised since
**1923**, it bills itself as **"o mais português de Portugal"**. Carnaval is a movable feast
tied to Easter, so it falls in February or early March. The programme runs across the whole
long weekend:

- Friday — the schools' parade in the morning, a masked ball, and the arrival of the King
  in the evening.
- Saturday — the **Corso Noturno**, the night parade.
- Sunday — the **Corso Diurno**.
- Monday — the **Corso Trapalhão**, the deliberately shambolic one.
- Tuesday — the daytime corso again.
- Ash Wednesday — the **Enterro do Entrudo**, the burial of Carnival.
...
**The farming and fishing year.** The **vindima** (grape harvest) in late summer/early
autumn; the pear and apple harvest through late summer; **santos populares** in June —
**Santo António** (13 June), **São João** (24 June) and **São Pedro** (29 June), the last of
which matters most in the fishing towns. Each concelho also has its own **feriado municipal**.

## Language notes

The Oeste speaks **Estremenho**, the central-southern dialect group that also covers Lisbon.
This is the variety usually treated as standard European Portuguese — one description calls
it the Portuguese equivalent of British *Received Pronunciation*. So there is **no strong
regional accent to imitate here**: a learner in Torres Vedras or Caldas is learning the
prestige norm, not a marked local variety. What distinguishes the zone is vocabulary —
weather, sea, farming and market words — rather than pronunciation.

Standard central-southern features apply: /b/ and /v/ stay distinct (unlike the north), and
*ei* and *ou* tend to monophthongise, so **peixe** leans toward "pêxe" and **outro** toward
"ôtro". Unstressed vowels reduce hard, as in all of European Portuguese.

Culturally, the inland half of the zone is **região saloia** — the historic rural belt around
Lisbon. Some authors put Torres Vedras, Mafra, Sobral de Monte Agraço, Cadaval, Arruda dos
Vinhos and Alenquer inside it.

**Words worth knowing here**

- `nortada` — the north/north-west wind that gets up in the afternoon, May to September.
- `arribas` — the sea cliffs along this coast.
- `aberta` — the channel through the sandbar where the Lagoa de Óbidos meets the sea.
- `tómbolo` — the sand isthmus that ties Peniche and Baleal to the mainland.
- `saloio` — a person from the rural hinterland of Lisbon; historically descriptive, but it
  can be used as an insult meaning "unsophisticated", so handle with care.
...
- `prato do dia` — the set lunch. `uma bica` — an espresso (correct here; *cimbalino* and
  *pingo* are northern words, do not use them). `um fino` / `uma imperial` — a small draught beer.
...
people across 15 freguesias, distrito de Lisboa. Known nationally for two things: its
**Carnaval** and its **wine**, being one of Portugal's foremost viticultural municipalities.
It is also the hinge of the **Linhas de Torres Vedras**, the Napoleonic defence works that
gave the town its place in European history.

- **Landmarks**: the **Castelo de Torres Vedras** on its hill, the **Chafariz dos Canos**
  fountain in the old town, and the **Forte de São Vicente** above the town — three joined
  redoubts inside a 1.5 km wall, the strongest single point of the Lines.
- **Food**: the `pastel de feijão`, a white-bean-and-almond tartlet made here since the late
  19th century and the town's genuine signature; and the wine — reds, whites and rosés from
  the surrounding quintas, with the Vinho Regional Lisboa commission seated in the town.
- **Everyday**: this is where people from the villages come for the hospital, the Finanças,
  the secondary schools and the big supermarkets. It is a *doing errands* town, not a
  sightseeing one, and it empties on Sunday.
...
**Praia do Centro**, **Praia da Física**, **Praia do Pisão**, **Praia do Guincho**, **Praia
Formosa**, **Praia da Amoeira**, **Praia de Santa Helena**, **Praia da Azenha**, **Praia do
Mirante** and **Praia do Navio** — locals refer to these individually, not to "Santa Cruz
beach". The **Rio Sizandro** reaches the sea just up the coast at **Praia Azul**.

- **Landmarks**: the **Penedo do Guincho**, the free-standing rock roughly 30 m high that is
...
A **World Surfing Reserve** — approved in February and dedicated in October **2011**, the
**first in Europe and the second in the world**. The reserve protects roughly 4–5 km of
coast holding an exceptional density of quality waves: **Pedra Branca**, **Reef**, **Ribeira
d'Ilhas**, **Cave**, **Crazy Left**, **Coxos** and **São Lourenço**. **Coxos**, off Ribamar,
is the one local surfers hold sacred — a reef pointbreak that barrels for seconds at a time.
Outside the reserve, **Foz do Lizandro** is the beginner and family beach and **Praia dos
Pescadores** is the town's own cove.

Administratively it is a **vila and freguesia of the concelho de Mafra, distrito de Lisboa**,
about 35 km north-west of the capital, with around 12 400 residents — so it is in the Área
Metropolitana de Lisboa, not OesteCIM, despite feeling like part of this coast.

Under the surf economy is a real fishing town: the harbour was once the **fourth most
important port in the country**, and in 1834 some 175 boats anchored there. From **Praia dos
Pescadores**, **D. Manuel II** left into exile on **5 October 1910** — the last king of
Portugal departed from this beach, and there is a plaque.
...
- **Everyday**: an unusual town in that it now has a permanent international population —
  ...
  standing complaint. The Lisbon-facing bus network makes commuting feasible.

### Mafra

A concelho of around 86 500 people, distrito de Lisboa, dominated by one building. The
...
Portugal's surf capital and one of its principal fishing ports, on a peninsula that was an
island until a **tómbolo** silted up permanently in the 18th century. Four freguesias —
Peniche, Atouguia da Baleia, Ferrel and Serra d'El-Rei — in the distrito de Leiria.
...
- **Everyday**: the working harbour sets the tone — the fish auction, the boats, the
  ...
  **Nossa Senhora da Boa Viagem**, on the Monday after the first Sunday in August, takes the
  image out onto the water. There is **no railway station**; everything comes in by road.

### Caldas da Rainha

The market and ceramics town, distrito de Leiria, and the practical capital of the northern
half of the zone. Founded on its water: Queen **D. Leonor** established the **Hospital Termal
Rainha D. Leonor** in **1485**, and it is the **oldest thermal hospital still operating in
the world**.

- **Landmarks**: the thermal hospital inside the **Parque D. Carlos I**, with the **Museu
...
- **Landmarks**: the **muralhas** you can walk; the castle keep, now a pousada; the **Porta
...
Research conducted August 2026 via web search and direct page retrieval. Principal sources:

- Comunidade Intermunicipal do Oeste (OesteCIM) — member municipalities and NUTS III Oeste:
  <https://pt.wikipedia.org/wiki/Comunidade_Intermunicipal_do_Oeste>,
  <https://www.cm-tvedras.pt/municipio/comunidade-intermunicipal>
- Oeste UNESCO Global Geopark: <https://www.unesco.org/en/iggp/oeste-unesco-global-geopark>,
  <https://www.geoparqueoeste.com/>
- Ericeira World Surfing Reserve: <https://www.savethewaves.org/ericeira/>,
  <https://pt.wikipedia.org/wiki/Ericeira>, <https://ericeirawsr10.com/en/coxos-2/>
- Palácio Nacional de Mafra / Real Edifício de Mafra (UNESCO 2019):
  <https://unescoportugal.mne.gov.pt/pt/temas/proteger-o-nosso-patrimonio-e-promover-a-criatividade/patrimonio-mundial-em-portugal/real-edificio-de-mafra-palacio-basilica-convento-jardim-do-cerco-tapada>,
  <https://pt.wikipedia.org/wiki/Pal%C3%A1cio_Nacional_de_Mafra>,
  <https://pt.wikipedia.org/wiki/Tapada_Nacional_de_Mafra>
- Mosteiro de Alcobaça (UNESCO 1989): <https://mosteiroalcobaca.gov.pt/unesco>,
  <https://pt.wikipedia.org/wiki/Alcoba%C3%A7a_(Portugal)>
- Fortaleza de Peniche / Museu Nacional Resistência e Liberdade:
  <https://www.museusemonumentos.pt/pt/museus-e-monumentos/museu-nacional-resistencia-e-liberdade>,
  <https://www.cm-peniche.pt/visitar/turismo/rotas-turisticas/caminho-do-atlantico/fortaleza-de-peniche>,
  <https://pt.wikipedia.org/wiki/Peniche>
- Hospital Termal Rainha D. Leonor and Caldas da Rainha:
  <https://www.mcr.pt/conhecer/museus-e-patrimonio/hospital-termal-rainha-d-leonor>,
  <https://pt.wikipedia.org/wiki/Caldas_da_Rainha>
- Linhas de Torres Vedras and Forte de São Vicente:
  <https://www.cm-tvedras.pt/artigos/detalhes/forte-de-sao-vicente>,
  <https://pt.wikipedia.org/wiki/Linhas_de_Torres_Vedras>
- Carnaval de Torres Vedras: <https://pt.wikipedia.org/wiki/Carnaval_de_Torres_Vedras>
- Nazaré, the Canhão and the surf records: <https://pt.wikipedia.org/wiki/Nazar%C3%A9_(Portugal)>,
  <https://pt.wikipedia.org/wiki/Santu%C3%A1rio_de_Nossa_Senhora_da_Nazar%C3%A9>,
  <https://www.surfertoday.com/surfing/guinness-world-records-confirm-garrett-mcnamaras-nazare-wave-as-the-biggest-ever>,
...
- Santa Cruz and Silveira: <https://pt.wikipedia.org/wiki/Praia_de_Santa_Cruz>,
  <https://pt.wikipedia.org/wiki/Torres_Vedras>
- Baleal: <https://pt.wikipedia.org/wiki/Baleal>
- São Martinho do Porto: <https://pt.wikipedia.org/wiki/S%C3%A3o_Martinho_do_Porto>
- Serra de Montejunto and Real Fábrica do Gelo:
  <https://pt.wikipedia.org/wiki/Serra_de_Montejunto>, <https://realfabricadogelo.pt/historia-do-lugar/>
- Rivers: <https://pt.wikipedia.org/wiki/Rio_Sizandro>, <https://pt.wikipedia.org/wiki/Rio_Alcabrichel>
- Nortada: <https://www.tempo.pt/noticias/actualidade/porque-esta-tanto-vento-nas-tardes-de-verao-saiba-o-que-origina-o-fenomeno-popularmente-conhecido-por-nortada-clima-portugal.html>
